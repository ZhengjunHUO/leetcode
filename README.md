...
2. About Go, normally I only import fmt to print out the result to check quickly if the algorithm works as expected. For some problems which engage data types, i use my <strike>[homemade thread-safe go data type (DEPRECATED)](https://github.com/ZhengjunHUO/godtype)</strike> [homemade generic thread-safe go data type](https://github.com/ZhengjunHUO/goutil).
